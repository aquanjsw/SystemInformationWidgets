...
var logger = Utils.LoggerFactory.CreateLogger<Program>();
...
var errno = CoRegisterClassObject(CLSID_Factory, new WidgetProviderFactory<WidgetProvider.WidgetProvider>(), 0x4, 0x1,
  out cookie);
if (errno != 0)
{
